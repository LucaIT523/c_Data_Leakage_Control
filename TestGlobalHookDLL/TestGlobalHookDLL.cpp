// TestGlobalHookDLL.cpp : Defines the initialization routines for the DLL.
//

#include "pch.h"
#include "framework.h"
#include "TestGlobalHookDLL.h"
...
BEGIN_MESSAGE_MAP(CTestGlobalHookDLLApp, CWinApp)
END_MESSAGE_MAP()


// CTestGlobalHookDLLApp construction

CTestGlobalHookDLLApp::CTestGlobalHookDLLApp()
{
...
// The one and only CTestGlobalHookDLLApp object

CTestGlobalHookDLLApp theApp;
...
// CTestGlobalHookDLLApp initialization

BOOL CTestGlobalHookDLLApp::InitInstance()
{
